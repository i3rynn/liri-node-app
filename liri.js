...
switch (action) {
  ...
  case "spotify-this-song":
    //Default song should display if user does not input one.
    getSongs(value)
    break;
  case "movie-this":
    //Default movie should display if user does not input one.
    if (value == "") {
      value = defaultMovie;
    }
    getMovies(value)
...
function getMovies(movieName) {
  axios.get("http://www.omdbapi.com/?apikey=42518777&t=" + movieName)
    ...
    //Mr. Nobody will display if user does not enter a title.
